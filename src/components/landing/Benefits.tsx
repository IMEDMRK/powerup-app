      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {benefitsList.map((benefit: any, index: number) => (
            <div
              key={index}
              className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative group overflow-hidden text-center"
            >
              ...
              {/* Icon / Emoji */}
              <div 
                className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-5 sm:mb-6 rounded-2xl flex justify-center items-center shadow-lg transform group-hover:scale-110 transition-transform duration-300 text-3xl sm:text-4xl relative z-10"
              ...
              {/* Text */}
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 relative z-10">{benefit.title}</h3>
